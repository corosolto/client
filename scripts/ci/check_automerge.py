...
def selftest() -> int:
    ...
    casos = [
        ...
        ("greptile pendente bloqueia",
         com(labels=[{"name": "safe-automerge"}, {"name": "needs-greptile-resolution"}]), False),
        ("greptile resolvido libera",
         com(labels=[{"name": "safe-automerge"}, {"name": "needs-greptile-resolution"},
                     {"name": "greptile-resolved"}]), True),
