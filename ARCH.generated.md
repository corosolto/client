...
|---|---|---|---|
| `public/` | o **jogo** | 57 arquivos `.js`, 37.403 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
