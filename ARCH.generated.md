...
|---|---|---|---|
| `public/` | o **jogo** | 102 arquivos `.js`, 49.380 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
...
`package.json` tem **312 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
