...
|---|---|---|---|
| `public/` | o **jogo** | 59 arquivos `.js`, 41.184 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 18 páginas `.astro`, 21 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 295 scripts em `tools/eval/`, 76 em `tools/` | node puro: sobe o jogo real sem browser |
