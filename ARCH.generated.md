...
|---|---|---|---|
| `public/` | o **jogo** | 96 arquivos `.js`, 48.396 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
