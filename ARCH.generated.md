...
|---|---|---|---|
| `public/` | o **jogo** | 97 arquivos `.js`, 51.053 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
