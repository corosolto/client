...
|---|---|---|---|
| `public/` | o **jogo** | 50 arquivos `.js`, 33.316 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
...
`package.json` tem **125 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
