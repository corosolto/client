...
| `tools/` | o **arnês** | 388 scripts em `tools/eval/`, 75 em `tools/` | node puro: sobe o jogo real sem browser |
...
`package.json` tem **282 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
