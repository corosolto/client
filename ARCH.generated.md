...
|---|---|---|---|
| `public/` | o **jogo** | 96 arquivos `.js`, 49.665 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
