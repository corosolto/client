...
|---|---|---|---|
| `public/` | o **jogo** | 59 arquivos `.js`, 41.317 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
