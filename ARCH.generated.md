...
|---|---|---|---|
| `public/` | o **jogo** | 47 arquivos `.js`, 32.700 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 19 páginas `.astro`, 21 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 205 scripts em `tools/eval/`, 55 em `tools/` | node puro: sobe o jogo real sem browser |
