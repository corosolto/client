...
|---|---|---|---|
| `public/` | o **jogo** | 50 arquivos `.js`, 33.318 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 20 páginas `.astro`, 21 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 207 scripts em `tools/eval/`, 55 em `tools/` | node puro: sobe o jogo real sem browser |
