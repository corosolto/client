...
|---|---|---|---|
| `public/` | o **jogo** | 93 arquivos `.js`, 46.914 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
