...
|---|---|---|---|
| `public/` | o **jogo** | 56 arquivos `.js`, 36.313 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
