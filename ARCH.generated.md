...
|---|---|---|---|
| `public/` | o **jogo** | 60 arquivos `.js`, 41.814 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
