...
|---|---|---|---|
| `public/` | o **jogo** | 55 arquivos `.js`, 40.249 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 18 páginas `.astro`, 19 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 263 scripts em `tools/eval/`, 73 em `tools/` | node puro: sobe o jogo real sem browser |
