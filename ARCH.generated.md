...
| `src/` | o **site** | 19 páginas `.astro`, 20 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 193 scripts em `tools/eval/`, 54 em `tools/` | node puro: sobe o jogo real sem browser |
