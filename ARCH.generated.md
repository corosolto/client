...
|---|---|---|---|
| `public/` | o **jogo** | 79 arquivos `.js`, 42.806 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
| `src/` | o **site** | 20 páginas `.astro`, 4 rotas `/api` · Astro `^7.1.1` | framework é bem-vindo; `service_role` só no servidor |
| `tools/` | o **arnês** | 304 scripts em `tools/eval/`, 69 em `tools/` | node puro: sobe o jogo real sem browser |
