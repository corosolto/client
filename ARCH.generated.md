...
|---|---|---|---|
| `public/` | o **jogo** | 90 arquivos `.js`, 44.543 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
