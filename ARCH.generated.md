...
|---|---|---|---|
| `public/` | o **jogo** | 90 arquivos `.js`, 45.049 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
