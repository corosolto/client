...
|---|---:|---|
| Game code | 31,982 lines in 44 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,920** lines | `wc -l public/js/game.js` |
...
| Version | `2.0.0-alpha.172` | `public/js/version.js` and `package.json` **DIVERGE** |
