...
|---|---:|---|
| Game code | 46,606 lines in 96 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,619** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 362 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
