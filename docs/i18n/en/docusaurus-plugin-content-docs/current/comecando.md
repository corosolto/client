...
|---|---:|---|
| Game code | 56,654 lines in 109 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 569 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **347 scripts**; the reason behind each one lives in `SCRIPTS.md`.
