...
|---|---:|---|
| Game code | 57,015 lines in 112 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8,099** lines | `wc -l public/js/game.js` |
| `main.js` | 3,661 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 598 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **421 scripts**; the reason behind each one lives in `SCRIPTS.md`.
