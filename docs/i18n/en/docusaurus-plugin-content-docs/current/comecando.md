...
|---|---:|---|
| Game code | 50,224 lines in 99 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,484** lines | `wc -l public/js/game.js` |
| `main.js` | 3,572 lines | `wc -l public/js/main.js` |
