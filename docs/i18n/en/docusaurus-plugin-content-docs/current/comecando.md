...
|---|---:|---|
| Game code | 41,603 lines in 60 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,341** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 296 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
