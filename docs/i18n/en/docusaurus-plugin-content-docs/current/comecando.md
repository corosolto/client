...
|---|---:|---|
| Game code | 46,389 lines in 92 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `penitenciaria` | Carandiru | **capture** | `map_penitenciaria.js` | 798 |
...
`package.json` has **229 scripts**; the reason behind each one lives in `SCRIPTS.md`.
