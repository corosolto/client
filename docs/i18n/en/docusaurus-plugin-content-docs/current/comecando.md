...
|---|---:|---|
| Game code | 33,469 lines in 50 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,142** lines | `wc -l public/js/game.js` |
| `main.js` | 2,989 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 207 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **127 scripts**; the reason behind each one lives in `SCRIPTS.md`.
