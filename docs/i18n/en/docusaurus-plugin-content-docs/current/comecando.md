...
|---|---:|---|
| Game code | 54,044 lines in 110 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 541 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **388 scripts**; the reason behind each one lives in `SCRIPTS.md`.
