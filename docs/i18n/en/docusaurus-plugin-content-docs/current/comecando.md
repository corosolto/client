...
|---|---:|---|
| Game code | 36,161 lines in 56 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,167** lines | `wc -l public/js/game.js` |
| `main.js` | 3,005 lines | `wc -l public/js/main.js` |
