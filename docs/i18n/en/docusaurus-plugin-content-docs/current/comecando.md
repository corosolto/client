...
|---|---:|---|
| Game code | 46,729 lines in 93 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 358 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
|---|---|---|---|---:|
| `mansao` | Mansão do Joá | **capture** | `map_mansao.js` | 1,391 |
