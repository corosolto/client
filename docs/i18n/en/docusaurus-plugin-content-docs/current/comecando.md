...
|---|---:|---|
| Game code | 51,969 lines in 99 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,533** lines | `wc -l public/js/game.js` |
| `main.js` | 3,601 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 431 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **268 scripts**; the reason behind each one lives in `SCRIPTS.md`.
