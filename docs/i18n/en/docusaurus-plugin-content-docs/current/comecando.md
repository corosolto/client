...
|---|---:|---|
| Game code | 36,871 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,220** lines | `wc -l public/js/game.js` |
| `main.js` | 3,195 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 218 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 62 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.209` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **135 scripts**; the reason behind each one lives in `SCRIPTS.md`.
