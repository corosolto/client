...
|---|---:|---|
| Game code | 36,684 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,200** lines | `wc -l public/js/game.js` |
| `main.js` | 3,179 lines | `wc -l public/js/main.js` |
...
| Version | `2.0.0-alpha.206` | `public/js/version.js` and `package.json` (match) |
