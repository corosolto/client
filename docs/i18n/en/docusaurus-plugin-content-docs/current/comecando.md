...
|---|---:|---|
| Game code | 35,209 lines in 52 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 209 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **126 scripts**; the reason behind each one lives in `SCRIPTS.md`.
