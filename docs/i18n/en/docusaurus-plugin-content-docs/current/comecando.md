...
|---|---:|---|
| Game code | 27,645 lines in 34 files | `cat public/js/*.js \| wc -l` |
...
| Harness scripts | 155 | `ls tools/eval/*.mjs tools/eval/*.py \| wc -l` |
...
`package.json` has **80 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
