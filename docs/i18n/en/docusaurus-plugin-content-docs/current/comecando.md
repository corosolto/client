...
|---|---:|---|
| Game code | 36,095 lines in 56 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,152** lines | `wc -l public/js/game.js` |
| `main.js` | 2,995 lines | `wc -l public/js/main.js` |
