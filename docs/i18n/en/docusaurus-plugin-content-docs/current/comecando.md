...
|---|---:|---|
| Game code | 32,611 lines in 47 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Pipeline scripts | 56 | `git ls-files 'tools/*.mjs' \| wc -l` |
...
`package.json` has **125 scripts**; the reason behind each one lives in `SCRIPTS.md`.
