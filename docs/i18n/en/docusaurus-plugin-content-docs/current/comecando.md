...
| Harness scripts | 184 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **111 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
