...
|---|---:|---|
| Game code | 31,917 lines in 45 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,531** lines | `wc -l public/js/game.js` |
| `main.js` | 2,591 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 190 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `treta_vietnan` | Treta no Vietnã | rounds | `map_treta_vietnan.js` | 547 |
...
`package.json` has **114 scripts**; the reason behind each one lives in `SCRIPTS.md`.
