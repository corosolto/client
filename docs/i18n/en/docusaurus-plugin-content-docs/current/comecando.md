...
|---|---:|---|
| Game code | 46,257 lines in 92 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 343 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **227 scripts**; the reason behind each one lives in `SCRIPTS.md`.
