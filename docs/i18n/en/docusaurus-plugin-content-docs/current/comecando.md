...
|---|---:|---|
| Game code | 39,543 lines in 67 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,368** lines | `wc -l public/js/game.js` |
| `main.js` | 3,379 lines | `wc -l public/js/main.js` |
...
`package.json` has **185 scripts**; the reason behind each one lives in `SCRIPTS.md`.
