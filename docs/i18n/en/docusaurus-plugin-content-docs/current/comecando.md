...
|---|---:|---|
| Game code | 42,871 lines in 63 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,260** lines | `wc -l public/js/game.js` |
| `main.js` | 2,817 lines | `wc -l public/js/main.js` |
...
| Props in GLB | 158 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Pipeline scripts | 82 | `git ls-files 'tools/*.mjs' \| wc -l` |
