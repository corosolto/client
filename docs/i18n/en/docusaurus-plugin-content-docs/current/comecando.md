...
|---|---:|---|
| Game code | 29,675 lines in 39 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Playable characters | 45, in 5 factions | `CHARACTERS` array in `characters.js` |
...
| Rule | Value | Constant |
|---|---|---|
| Factions · characters | 5 · 45 (B 9 · C 9 · E 9 · F 9 · U 9) | `CHARACTERS` |
