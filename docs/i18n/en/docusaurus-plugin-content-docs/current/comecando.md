...
|---|---:|---|
| Game code | 32,646 lines in 46 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,122** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 204 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
