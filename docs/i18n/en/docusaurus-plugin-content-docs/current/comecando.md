...
|---|---:|---|
| Game code | 37,027 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,235** lines | `wc -l public/js/game.js` |
...
| Version | `2.0.0-alpha.215` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **138 scripts**; the reason behind each one lives in `SCRIPTS.md`.
