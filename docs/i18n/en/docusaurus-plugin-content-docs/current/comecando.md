...
|---|---:|---|
| Game code | 51,990 lines in 99 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 432 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **269 scripts**; the reason behind each one lives in `SCRIPTS.md`.
