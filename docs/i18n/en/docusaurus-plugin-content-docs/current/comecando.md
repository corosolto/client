...
|---|---:|---|
| Game code | 53,872 lines in 108 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,938** lines | `wc -l public/js/game.js` |
| `main.js` | 3,598 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 517 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **316 scripts**; the reason behind each one lives in `SCRIPTS.md`.
