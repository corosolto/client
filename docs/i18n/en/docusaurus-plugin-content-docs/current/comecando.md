...
|---|---:|---|
| Game code | 45,882 lines in 64 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,401** lines | `wc -l public/js/game.js` |
| `main.js` | 2,823 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 310 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **195 scripts**; the reason behind each one lives in `SCRIPTS.md`.
