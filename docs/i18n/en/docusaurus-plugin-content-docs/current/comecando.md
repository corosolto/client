...
|---|---:|---|
| Game code | 54,614 lines in 108 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,948** lines | `wc -l public/js/game.js` |
...
`package.json` has **329 scripts**; the reason behind each one lives in `SCRIPTS.md`.
