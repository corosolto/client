...
|---|---:|---|
| Game code | 53,992 lines in 109 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8,044** lines | `wc -l public/js/game.js` |
...
`package.json` has **387 scripts**; the reason behind each one lives in `SCRIPTS.md`.
