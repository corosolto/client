...
|---|---:|---|
| Game code | 46,259 lines in 92 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 344 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `penitenciaria` | Penitenciária da Treta | **capture** | `map_penitenciaria.js` | 668 |
