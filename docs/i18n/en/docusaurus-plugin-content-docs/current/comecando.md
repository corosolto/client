...
|---|---:|---|
| Game code | 37,090 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,238** lines | `wc -l public/js/game.js` |
| `main.js` | 3,253 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 224 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 58 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.217` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **143 scripts**; the reason behind each one lives in `SCRIPTS.md`.
