...
|---|---:|---|
| Game code | 40,083 lines in 55 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,954** lines | `wc -l public/js/game.js` |
...
`package.json` has **161 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
