...
|---|---:|---|
| Game code | 53,916 lines in 108 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 520 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **322 scripts**; the reason behind each one lives in `SCRIPTS.md`.
