...
|---|---:|---|
| Game code | 53,088 lines in 108 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 510 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `penitenciaria` | Penitenciária da Treta | **capture** | `map_penitenciaria.js` | 265 |
