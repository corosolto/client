...
|---|---:|---|
| Game code | 47,050 lines in 94 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,469** lines | `wc -l public/js/game.js` |
| `main.js` | 3,485 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 368 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `escadao` | Escadão (Morro) | **capture** | `map_escadao.js` | 1,405 |
...
`package.json` has **237 scripts**; the reason behind each one lives in `SCRIPTS.md`.
