...
|---|---:|---|
| Game code | 49,721 lines in 96 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 412 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **254 scripts**; the reason behind each one lives in `SCRIPTS.md`.
