...
|---|---:|---|
| Game code | 53,997 lines in 109 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8,047** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 540 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
