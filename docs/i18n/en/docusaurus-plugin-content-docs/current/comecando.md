...
|---|---:|---|
| Game code | 54,385 lines in 108 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 533 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `piscina_treta` | Piscina da Treta | rounds | `map_piscina.js` | 1,094 |
...
`package.json` has **324 scripts**; the reason behind each one lives in `SCRIPTS.md`.
