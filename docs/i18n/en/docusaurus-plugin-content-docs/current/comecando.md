...
|---|---:|---|
| Game code | 37,545 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,305** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 228 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
