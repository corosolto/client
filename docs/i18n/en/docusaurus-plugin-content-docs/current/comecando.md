...
|---|---:|---|
| Game code | 56,458 lines in 112 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8,094** lines | `wc -l public/js/game.js` |
...
| Props in GLB | 190 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Harness scripts | 594 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 100 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.287` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **417 scripts**; the reason behind each one lives in `SCRIPTS.md`.
