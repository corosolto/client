...
| Version | `2.0.0-alpha.237` | `public/js/version.js` and `package.json` (match) |
...
| `velho_oeste` | Sertão da Treta | **capture** | `map_velho_oeste.js` | 1,009 |
...
`package.json` has **220 scripts**; the reason behind each one lives in `SCRIPTS.md`.
