...
|---|---:|---|
| Game code | 37,048 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 221 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **144 scripts**; the reason behind each one lives in `SCRIPTS.md`.
