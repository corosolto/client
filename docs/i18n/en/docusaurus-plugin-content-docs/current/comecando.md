...
|---|---:|---|
| Game code | 43,871 lines in 66 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,559** lines | `wc -l public/js/game.js` |
...
`package.json` has **200 scripts**; the reason behind each one lives in `SCRIPTS.md`.
