...
|---|---:|---|
| Game code | 46,450 lines in 92 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `penitenciaria` | Carandiru | **capture** | `map_penitenciaria.js` | 859 |
...
`package.json` has **230 scripts**; the reason behind each one lives in `SCRIPTS.md`.
