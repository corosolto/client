...
|---|---:|---|
| Game code | 53,066 lines in 108 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,938** lines | `wc -l public/js/game.js` |
| `main.js` | 3,589 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 509 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **315 scripts**; the reason behind each one lives in `SCRIPTS.md`.
