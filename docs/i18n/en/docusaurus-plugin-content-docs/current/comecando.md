...
|---|---:|---|
| Game code | 49,167 lines in 96 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,515** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 408 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **252 scripts**; the reason behind each one lives in `SCRIPTS.md`.
