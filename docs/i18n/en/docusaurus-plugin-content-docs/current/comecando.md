...
|---|---:|---|
| Game code | 44,912 lines in 90 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `quebrada` | Quebrada (Rua do Baile) | **capture** | `map_quebrada.js` | 1,654 |
...
`package.json` has **232 scripts**; the reason behind each one lives in `SCRIPTS.md`.
