...
|---|---:|---|
| Game code | 44,868 lines in 90 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,446** lines | `wc -l public/js/game.js` |
...
| `velho_oeste` | Sertão da Treta | **capture** | `map_velho_oeste.js` | 1,060 |
