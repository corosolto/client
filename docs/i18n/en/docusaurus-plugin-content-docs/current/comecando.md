...
|---|---:|---|
| Game code | 39,864 lines in 55 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `loja_h` | Loja H (Estacionamento) | **capture** | `map_havan.js` | 2,001 |
...
`package.json` has **160 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
