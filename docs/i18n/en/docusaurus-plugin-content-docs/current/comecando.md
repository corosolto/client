...
|---|---:|---|
| Game code | 54,683 lines in 111 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8,045** lines | `wc -l public/js/game.js` |
| `main.js` | 3,624 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 562 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **407 scripts**; the reason behind each one lives in `SCRIPTS.md`.
