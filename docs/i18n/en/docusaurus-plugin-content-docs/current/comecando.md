...
|---|---:|---|
| Game code | 56,503 lines in 109 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,994** lines | `wc -l public/js/game.js` |
| `main.js` | 3,660 lines | `wc -l public/js/main.js` |
...
| Props in GLB | 197 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Version | `2.0.0-alpha.289` | `public/js/version.js` and `package.json` (match) |
...
| `atacadao_treta` | Atacadão da Treta | **capture** | `map_atacadao.js` | 786 |
...
`package.json` has **339 scripts**; the reason behind each one lives in `SCRIPTS.md`.
