...
|---|---:|---|
| Game code | 39,724 lines in 65 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,365** lines | `wc -l public/js/game.js` |
| `main.js` | 3,373 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 249 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **163 scripts**; the reason behind each one lives in `SCRIPTS.md`.
