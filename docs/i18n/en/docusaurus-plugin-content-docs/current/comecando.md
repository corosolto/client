...
|---|---:|---|
| Game code | 46,894 lines in 93 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 365 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 75 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.249` | `public/js/version.js` and `package.json` (match) |
