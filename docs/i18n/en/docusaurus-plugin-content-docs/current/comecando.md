...
|---|---:|---|
| Game code | 39,760 lines in 65 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,365** lines | `wc -l public/js/game.js` |
| `main.js` | 3,375 lines | `wc -l public/js/main.js` |
...
| Props in GLB | 128 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Harness scripts | 250 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **164 scripts**; the reason behind each one lives in `SCRIPTS.md`.
