...
|---|---:|---|
| Game code | 52,001 lines in 99 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,555** lines | `wc -l public/js/game.js` |
...
| Props in GLB | 191 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Harness scripts | 433 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **270 scripts**; the reason behind each one lives in `SCRIPTS.md`.
