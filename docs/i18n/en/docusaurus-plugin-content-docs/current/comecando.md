...
|---|---:|---|
| Game code | 36,366 lines in 56 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,170** lines | `wc -l public/js/game.js` |
| `main.js` | 3,135 lines | `wc -l public/js/main.js` |
