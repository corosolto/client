...
|---|---:|---|
| Game code | 39,519 lines in 64 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
|---|---|---|---|---:|
| `escadao` | Escadão (Morro) | **capture** | `map_escadao.js` | 1,280 |
...
`package.json` has **177 scripts**; the reason behind each one lives in `SCRIPTS.md`.
