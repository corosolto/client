...
|---|---:|---|
| Game code | 43,048 lines in 64 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,382** lines | `wc -l public/js/game.js` |
...
`package.json` has **192 scripts**; the reason behind each one lives in `SCRIPTS.md`.
