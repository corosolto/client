...
|---|---:|---|
| Game code | 46,837 lines in 93 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props in GLB | 165 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| `escadao` | Escadão (Morro) | **capture** | `map_escadao.js` | 1,410 |
...
`package.json` has **235 scripts**; the reason behind each one lives in `SCRIPTS.md`.
