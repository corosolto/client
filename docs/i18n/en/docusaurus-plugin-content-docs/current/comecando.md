...
|---|---:|---|
| Game code | 41,103 lines in 59 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,244** lines | `wc -l public/js/game.js` |
| `main.js` | 2,794 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 293 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **181 scripts**; the reason behind each one lives in `SCRIPTS.md`.
