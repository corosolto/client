...
|---|---:|---|
| Game code | 34,957 lines in 51 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,918** lines | `wc -l public/js/game.js` |
...
| `corrego` | Córrego (Favela de SP) | **capture** | `map_corrego.js` | 1,284 |
