...
|---|---:|---|
| Game code | 33,141 lines in 47 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,068** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 205 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 55 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.191` | `public/js/version.js` and `package.json` (match) |
