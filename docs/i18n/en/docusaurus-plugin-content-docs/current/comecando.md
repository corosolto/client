...
|---|---:|---|
| Game code | 40,279 lines in 55 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `fy_lajes` | Lajes (Comunidade) | **capture** | `map_lajes_authored.js` | 1,208 |
| `fy_corrego` | Córrego (Favela de SP) | **capture** | `map_corrego.js` | 1,543 |
