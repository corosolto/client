...
|---|---:|---|
| Game code | 51,100 lines in 97 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 425 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **261 scripts**; the reason behind each one lives in `SCRIPTS.md`.
