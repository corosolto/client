...
|---|---:|---|
| Game code | 41,182 lines in 59 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,291** lines | `wc -l public/js/game.js` |
| `main.js` | 2,813 lines | `wc -l public/js/main.js` |
