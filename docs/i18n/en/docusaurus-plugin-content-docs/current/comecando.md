...
|---|---:|---|
| Game code | 32,226 lines in 45 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,901** lines | `wc -l public/js/game.js` |
| `main.js` | 2,684 lines | `wc -l public/js/main.js` |
