...
|---|---:|---|
| Game code | 44,713 lines in 90 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,422** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 341 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 72 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.240` | `public/js/version.js` and `package.json` (match) |
...
| `velho_oeste` | Sertão da Treta | **capture** | `map_velho_oeste.js` | 1,049 |
...
`package.json` has **224 scripts**; the reason behind each one lives in `SCRIPTS.md`.
