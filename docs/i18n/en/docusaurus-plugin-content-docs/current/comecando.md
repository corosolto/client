...
|---|---:|---|
| Game code | 40,419 lines in 59 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 287 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **174 scripts**; the reason behind each one lives in `SCRIPTS.md`.
