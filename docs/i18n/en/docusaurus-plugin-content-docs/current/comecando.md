...
|---|---:|---|
| Game code | 50,180 lines in 102 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,678** lines | `wc -l public/js/game.js` |
...
`package.json` has **313 scripts**; the reason behind each one lives in `SCRIPTS.md`.
