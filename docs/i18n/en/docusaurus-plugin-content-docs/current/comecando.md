...
|---|---:|---|
| Game code | 44,672 lines in 90 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 339 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `velho_oeste` | Sertão da Treta | **capture** | `map_velho_oeste.js` | 1,013 |
