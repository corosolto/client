...
|---|---:|---|
| Game code | 31,715 lines in 41 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,623** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 199 | `ls tools/eval/*.mjs tools/eval/*.py \| wc -l` |
...
| `piscina_treta` | Piscina da Treta | rounds | `map_piscina.js` | 850 |
| `loja_h` | Loja H (Estacionamento) | **capture** | `map_havan.js` | 1,945 |
...
`package.json` has **121 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
