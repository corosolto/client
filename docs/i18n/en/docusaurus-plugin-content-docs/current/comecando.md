...
|---|---:|---|
| Game code | 27,725 lines in 34 files | `cat public/js/*.js \| wc -l` |
| `game.js` | **6,467** lines | `wc -l public/js/game.js` |
| `main.js` | 2,016 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 161 | `ls tools/eval/*.mjs tools/eval/*.py \| wc -l` |
| Pipeline scripts | 46 | `ls tools/*.mjs \| wc -l` |
| Written entry tasks | 26 | `ls docs/issues/[0-9]*.md \| wc -l` |
| Version | `2.0.0-alpha.93` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **85 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
