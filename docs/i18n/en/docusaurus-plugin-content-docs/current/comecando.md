...
|---|---:|---|
| Game code | 33,237 lines in 49 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,980** lines | `wc -l public/js/game.js` |
| `main.js` | 2,946 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 206 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
