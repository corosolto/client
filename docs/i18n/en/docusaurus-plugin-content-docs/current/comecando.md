...
|---|---:|---|
| Game code | 27,594 lines in 34 files | `cat public/js/*.js \| wc -l` |
...
| Harness scripts | 154 | `ls tools/eval/*.mjs tools/eval/*.py \| wc -l` |
...
`package.json` has **79 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
