...
|---|---:|---|
| Game code | 40,249 lines in 55 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props in GLB | 138 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| `fy_corrego` | Córrego (Favela de SP) | **capture** | `map_corrego.js` | 1,540 |
| `fy_mansao` | Mansão do Joá | **capture** | `map_mansao.js` | 815 |
...
| `penitenciaria` | Penitenciária da Treta | **capture** | `map_penitenciaria.js` | 261 |
...
`package.json` has **164 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
