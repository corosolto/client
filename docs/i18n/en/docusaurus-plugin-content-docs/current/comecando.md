...
|---|---:|---|
| Game code | 42,903 lines in 63 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props in GLB | 160 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Harness scripts | 313 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 84 | `git ls-files 'tools/*.mjs' \| wc -l` |
