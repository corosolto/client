...
|---|---:|---|
| Game code | 46,523 lines in 92 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 347 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `penitenciaria` | Carandiru | **capture** | `map_penitenciaria.js` | 932 |
