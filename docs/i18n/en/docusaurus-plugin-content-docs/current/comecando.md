...
|---|---:|---|
| Game code | 33,318 lines in 50 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6,990** lines | `wc -l public/js/game.js` |
| `main.js` | 2,990 lines | `wc -l public/js/main.js` |
