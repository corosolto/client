...
|---|---:|---|
| Game code | 46,261 lines in 92 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `parque_treta` | Parque da Treta | **capture** | `map_parque.js` | 817 |
| `velho_oeste` | Sertão da Treta | **capture** | `map_velho_oeste.js` | 889 |
| `penitenciaria` | Penitenciária da Treta | **capture** | `map_penitenciaria.js` | 666 |
