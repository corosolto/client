...
|---|---:|---|
| Game code | 56,942 lines in 109 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8,017** lines | `wc -l public/js/game.js` |
| `main.js` | 3,678 lines | `wc -l public/js/main.js` |
...
`package.json` has **350 scripts**; the reason behind each one lives in `SCRIPTS.md`.
