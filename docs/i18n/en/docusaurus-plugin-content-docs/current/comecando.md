...
|---|---:|---|
| Game code | 42,732 lines in 78 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 299 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 69 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.228` | `public/js/version.js` and `package.json` (match) |
