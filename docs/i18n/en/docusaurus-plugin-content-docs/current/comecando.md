...
|---|---:|---|
| Game code | 44,511 lines in 89 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,407** lines | `wc -l public/js/game.js` |
...
`package.json` has **217 scripts**; the reason behind each one lives in `SCRIPTS.md`.
