...
|---|---:|---|
| Game code | 37,725 lines in 58 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,331** lines | `wc -l public/js/game.js` |
| `main.js` | 3,364 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 229 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 62 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.219` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **154 scripts**; the reason behind each one lives in `SCRIPTS.md`.
