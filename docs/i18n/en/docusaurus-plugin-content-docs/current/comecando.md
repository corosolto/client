...
|---|---:|---|
| Game code | 45,336 lines in 90 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props in GLB | 161 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Harness scripts | 353 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `atacadao_treta` | Atacadão da Treta | **capture** | `map_atacadao.js` | 734 |
