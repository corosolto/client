...
|---|---:|---|
| Game code | 40,912 lines in 59 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,188** lines | `wc -l public/js/game.js` |
| `main.js` | 2,781 lines | `wc -l public/js/main.js` |
