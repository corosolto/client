...
|---|---:|---|
| Game code | 37,332 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,279** lines | `wc -l public/js/game.js` |
| `main.js` | 3,254 lines | `wc -l public/js/main.js` |
...
`package.json` has **150 scripts**; the reason behind each one lives in `SCRIPTS.md`.
