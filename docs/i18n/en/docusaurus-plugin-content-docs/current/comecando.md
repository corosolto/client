...
|---|---:|---|
| Game code | 37,403 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,290** lines | `wc -l public/js/game.js` |
...
`package.json` has **152 scripts**; the reason behind each one lives in `SCRIPTS.md`.
