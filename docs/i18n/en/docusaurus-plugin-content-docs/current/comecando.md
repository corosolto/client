...
|---|---:|---|
| Game code | 42,946 lines in 81 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 308 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 69 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.234` | `public/js/version.js` and `package.json` (match) |
