...
|---|---:|---|
| Game code | 47,021 lines in 94 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,466** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 367 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
