...
|---|---:|---|
| Game code | 41,184 lines in 59 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,279** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 295 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
