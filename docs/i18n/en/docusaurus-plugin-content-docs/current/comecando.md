...
|---|---:|---|
| Game code | 40,683 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 271 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **166 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
