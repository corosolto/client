...
|---|---:|---|
| Game code | 55,951 lines in 109 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,994** lines | `wc -l public/js/game.js` |
| `main.js` | 3,662 lines | `wc -l public/js/main.js` |
...
`package.json` has **335 scripts**; the reason behind each one lives in `SCRIPTS.md`.
