...
|---|---:|---|
| Game code | 46,962 lines in 94 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,435** lines | `wc -l public/js/game.js` |
| `main.js` | 3,488 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 366 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **234 scripts**; the reason behind each one lives in `SCRIPTS.md`.
