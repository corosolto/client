...
|---|---:|---|
| Game code | 36,929 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,220** lines | `wc -l public/js/game.js` |
...
| Harness scripts | 220 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 62 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.210` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **137 scripts**; the reason behind each one lives in `SCRIPTS.md`.
