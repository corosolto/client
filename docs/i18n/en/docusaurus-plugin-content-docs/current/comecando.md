...
|---|---:|---|
| Game code | 56,643 lines in 109 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7,995** lines | `wc -l public/js/game.js` |
| `main.js` | 3,659 lines | `wc -l public/js/main.js` |
...
| Props in GLB | 202 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Harness scripts | 568 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Pipeline scripts | 100 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Written entry tasks | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Version | `2.0.0-alpha.293` | `public/js/version.js` and `package.json` (match) |
...
`package.json` has **346 scripts**; the reason behind each one lives in `SCRIPTS.md`.
