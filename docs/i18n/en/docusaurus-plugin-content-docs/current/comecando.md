...
|---|---:|---|
| Game code | 40,740 lines in 57 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
`package.json` has **167 scripts**. Keys prefixed with `//` explain why the adjacent command exists.
