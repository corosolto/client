...
|---|---:|---|
| Game code | 55,128 lines in 111 files | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8,055** lines | `wc -l public/js/game.js` |
| `main.js` | 3,657 lines | `wc -l public/js/main.js` |
...
| Harness scripts | 580 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` has **411 scripts**; the reason behind each one lives in `SCRIPTS.md`.
