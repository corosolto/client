...
|---|---:|---|
| Game code | 40,311 lines in 56 files | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Harness scripts | 266 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `fy_mansao` | Mansão do Joá | **capture** | `map_mansao.js` | 810 |
