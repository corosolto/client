...
**6 human author identities** sign commits in this branch: `ruben-cytonic`, `William Oliveira`, `Juan Versolato Lopes`, `Ruben`, `Ruben Marcus`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
