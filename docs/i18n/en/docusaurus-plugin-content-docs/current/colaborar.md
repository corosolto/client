...
**11 human author identities** sign commits in this branch: `ruben-cytonic`, `Ruben Marcus`, `rubenmarcus`, `Ruben`, `Emerson Garrido`, `William Oliveira`, `Juan Versolato Lopes`, `daeeseD`, `matheusgb`, `Maná Soares`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
...
| `amazonia` | Treta na Amazônia | **capture** | `map_amazonia.js` | 1,106 |
