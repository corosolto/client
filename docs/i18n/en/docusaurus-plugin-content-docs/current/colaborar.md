...
**14 human author identities** sign commits in this branch: `rubenmarcus`, `ruben-cytonic`, `Ruben`, `Emerson Garrido`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `nunreasonable`, `daeeseD`, `Maná Soares`, `matheusgb`, `Nicholas Velten`, `daltonfontes`, `usantos`. Automated identities are excluded. A Git author name is not necessarily one unique person.
