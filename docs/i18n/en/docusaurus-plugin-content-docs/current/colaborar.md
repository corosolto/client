...
**10 human author identities** sign commits in this branch: `ruben-cytonic`, `Ruben Marcus`, `Emerson Garrido`, `Ruben`, `rubenmarcus`, `William Oliveira`, `Juan Versolato Lopes`, `matheusgb`, `daeeseD`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
