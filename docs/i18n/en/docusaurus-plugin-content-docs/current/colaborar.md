...
**9 human author identities** sign commits in this branch: `ruben-cytonic`, `Emerson Garrido`, `Ruben Marcus`, `rubenmarcus`, `Ruben`, `William Oliveira`, `Juan Versolato Lopes`, `matheusgb`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
