...
**9 human author identities** sign commits in this branch: `ruben-cytonic`, `Emerson Garrido`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `Ruben`, `matheusgb`, `daltonfontes`, `rubenmarcus`. Automated identities are excluded. A Git author name is not necessarily one unique person.
...
| `loja_h` | Loja H (Estacionamento) | **capture** | `map_havan.js` | 1,976 |
