...
**11 human author identities** sign commits in this branch: `ruben-cytonic`, `Ruben Marcus`, `rubenmarcus`, `Emerson Garrido`, `Ruben`, `William Oliveira`, `Juan Versolato Lopes`, `daeeseD`, `matheusgb`, `Maná Soares`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
