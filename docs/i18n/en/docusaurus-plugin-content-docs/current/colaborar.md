...
**13 human author identities** sign commits in this branch: `ruben-cytonic`, `rubenmarcus`, `Ruben`, `Emerson Garrido`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `daeeseD`, `nunreasonable`, `Maná Soares`, `matheusgb`, `daltonfontes`, `usantos`. Automated identities are excluded. A Git author name is not necessarily one unique person.
