...
**11 human author identities** sign commits in this branch: `ruben-cytonic`, `Emerson Garrido`, `rubenmarcus`, `Ruben`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `estraga-codigo`, `matheusgb`, `Ubiracy`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
