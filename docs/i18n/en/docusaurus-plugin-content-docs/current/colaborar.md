...
**14 human author identities** sign commits in this branch: `rubenmarcus`, `ruben-cytonic`, `Ruben Marcus`, `Ruben`, `Emerson Garrido`, `William Oliveira`, `Juan Versolato Lopes`, `daeeseD`, `nunreasonable`, `Maná Soares`, `matheusgb`, `Nicholas Velten`, `daltonfontes`, `usantos`. Automated identities are excluded. A Git author name is not necessarily one unique person.
