...
**10 human author identities** sign commits in this branch: `ruben-cytonic`, `Emerson Garrido`, `Ruben`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `matheusgb`, `rubenmarcus`, `Bernardo Marques`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
