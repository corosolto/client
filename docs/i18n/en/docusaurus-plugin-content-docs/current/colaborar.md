...
**8 human author identities** sign commits in this branch: `ruben-cytonic`, `Emerson Garrido`, `Ruben Marcus`, `William Oliveira`, `Juan Versolato Lopes`, `matheusgb`, `Ruben`, `daltonfontes`. Automated identities are excluded. A Git author name is not necessarily one unique person.
