...
- `tools/eval/invariants.mjs`: **2.332 linhas**, **69 identificadores de invariante declarados** (`put()`), dos quais **28** têm caminho de `skip()` declarado.
- O arnês inteiro são **494 scripts** em `tools/eval/` (`.mjs` + `.py`), mais **95 scripts** de pipeline em `tools/`.
