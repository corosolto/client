...
- `tools/eval/invariants.mjs`: **2.286 linhas**, **65 identificadores de invariante declarados** (`put()`), dos quais **28** têm caminho de `skip()` declarado.
- O arnês inteiro são **250 scripts** em `tools/eval/` (`.mjs` + `.py`), mais **66 scripts** de pipeline em `tools/`.
