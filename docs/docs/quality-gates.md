...
- `tools/eval/invariants.mjs`: **2.353 linhas**, **70 identificadores de invariante declarados** (`put()`), dos quais **29** têm caminho de `skip()` declarado.
- O arnês inteiro são **572 scripts** em `tools/eval/` (`.mjs` + `.py`), mais **100 scripts** de pipeline em `tools/`.
