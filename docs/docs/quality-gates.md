...
- `tools/eval/invariants.mjs`: **2.300 linhas**, **67 identificadores de invariante declarados** (`put()`), dos quais **28** têm caminho de `skip()` declarado.
- O arnês inteiro são **267 scripts** em `tools/eval/` (`.mjs` + `.py`), mais **58 scripts** de pipeline em `tools/`.
