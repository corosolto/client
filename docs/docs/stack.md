...
`mint-assets.json` registra **71 assets** gerados via Mint (32 `mint-model` · 13 `mint-asset-pack` · 5 `mint-text-to-3d` · 9 `mint-chat` · 4 `local-derivative` · 1 `openrouter-image-concept` · 4 `replicate-gen` · 3 `mint-asset-pack-item`), cada um com `assetId`, `chatUrl` e notas do que deu errado na tentativa anterior.
