...
`mint-assets.json` registra **8 assets** gerados via Mint (4 `mint-model` · 4 `mint-asset-pack`), cada um com `assetId`, `chatUrl` e notas do que deu errado na tentativa anterior.
