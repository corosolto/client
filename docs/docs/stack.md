...
`mint-assets.json` registra **60 assets** gerados via Mint (28 `mint-model` · 13 `mint-asset-pack` · 5 `mint-text-to-3d` · 9 `mint-chat` · 4 `local-derivative` · 1 `openrouter-image-concept`), cada um com `assetId`, `chatUrl` e notas do que deu errado na tentativa anterior.
