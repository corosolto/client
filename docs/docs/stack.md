...
`mint-assets.json` registra **28 assets** gerados via Mint (5 `mint-model` · 9 `mint-asset-pack` · 9 `mint-chat` · 4 `local-derivative` · 1 `mint-text-to-3d`), cada um com `assetId`, `chatUrl` e notas do que deu errado na tentativa anterior.
