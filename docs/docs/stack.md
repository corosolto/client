...
`mint-assets.json` registra **37 assets** gerados via Mint (30 `mint-model` · 2 `tripo3d-task` · 5 `mint-asset-pack`), cada um com `assetId`, `chatUrl` e notas do que deu errado na tentativa anterior.
