...
`mint-assets.json` registra **18 assets** gerados via Mint (10 `mint-model` · 4 `mint-asset-pack` · 4 `mint-text-to-3d`), cada um com `assetId`, `chatUrl` e notas do que deu errado na tentativa anterior.
