...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.366 |
| `public/js/main.js` | 2.823 |
...
Total de `public/js/`: **42.905 linhas em 64 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
