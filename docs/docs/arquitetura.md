...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.472 |
| `public/js/main.js` | 3.521 |
...
Total de `public/js/`: **47.387 linhas em 96 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
