...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.220 |
| `public/js/main.js` | 3.253 |
...
Total de `public/js/`: **36.929 linhas em 57 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
