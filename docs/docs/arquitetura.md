...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.219 |
| `public/js/main.js` | 3.195 |
| `public/js/characters.js` | 1.068 |
| `public/js/glbchars.js` | 844 |
| `public/js/vmattach.js` | 628 |
| `public/js/weapons.js` | 350 |
| `public/js/springs.js` | 260 |

Total de `public/js/`: **36.845 linhas em 57 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
