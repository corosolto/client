...
| `public/js/characters.js` | 1.095 |
| `public/js/glbchars.js` | 851 |
| `public/js/vmattach.js` | 628 |
| `public/js/weapons.js` | 353 |
| `public/js/springs.js` | 260 |

Total de `public/js/`: **44.612 linhas em 90 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
