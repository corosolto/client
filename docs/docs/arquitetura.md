...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.345 |
| `public/js/main.js` | 2.815 |
| `public/js/characters.js` | 1.133 |
| `public/js/glbchars.js` | 954 |
| `public/js/vmattach.js` | 628 |
| `public/js/weapons.js` | 356 |
| `public/js/springs.js` | 260 |

Total de `public/js/`: **41.670 linhas em 60 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
