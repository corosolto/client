...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.244 |
| `public/js/main.js` | 2.794 |
...
Total de `public/js/`: **41.103 linhas em 59 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
