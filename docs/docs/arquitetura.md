...
| `public/js/glbchars.js` | 840 |
| `public/js/vmattach.js` | 628 |
| `public/js/weapons.js` | 347 |
| `public/js/springs.js` | 260 |

Total de `public/js/`: **31.965 linhas em 44 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
