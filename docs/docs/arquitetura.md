...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.994 |
| `public/js/main.js` | 3.662 |
...
Total de `public/js/`: **55.951 linhas em 109 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
