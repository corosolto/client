...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.533 |
| `public/js/main.js` | 3.601 |
...
Total de `public/js/`: **51.457 linhas em 99 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
