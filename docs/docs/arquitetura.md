...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.552 |
| `public/js/main.js` | 2.826 |
| `public/js/characters.js` | 1.168 |
| `public/js/glbchars.js` | 969 |
| `public/js/vmattach.js` | 634 |
| `public/js/weapons.js` | 365 |
| `public/js/springs.js` | 259 |

Total de `public/js/`: **43.723 linhas em 65 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
