...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 8.045 |
| `public/js/main.js` | 3.632 |
...
Total de `public/js/`: **54.379 linhas em 111 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
