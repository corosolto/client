...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.980 |
| `public/js/main.js` | 2.946 |
...
Total de `public/js/`: **33.237 linhas em 49 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
