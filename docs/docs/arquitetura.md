...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.152 |
| `public/js/main.js` | 2.995 |
...
Total de `public/js/`: **36.095 linhas em 56 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
