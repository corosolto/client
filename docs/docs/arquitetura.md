...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.167 |
| `public/js/main.js` | 3.126 |
...
Total de `public/js/`: **36.304 linhas em 56 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
