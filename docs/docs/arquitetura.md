...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 8.017 |
| `public/js/main.js` | 3.673 |
...
Total de `public/js/`: **56.937 linhas em 109 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
