...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.845 |
| `public/js/main.js` | 3.540 |
...
Total de `public/js/`: **52.208 linhas em 105 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
...
- `KNOWN-BUGS.md` → `map_lajes_authored.js:491` (o arquivo tem 391 linhas)
