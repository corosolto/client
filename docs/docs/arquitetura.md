...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.200 |
| `public/js/main.js` | 3.179 |
...
Total de `public/js/`: **36.685 linhas em 57 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
