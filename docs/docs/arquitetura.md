...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.955 |
| `public/js/main.js` | 3.658 |
...
Total de `public/js/`: **54.624 linhas em 108 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
