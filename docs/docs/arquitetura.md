...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.428 |
| `public/js/main.js` | 3.408 |
...
Total de `public/js/`: **46.808 linhas em 93 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
