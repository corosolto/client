...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.901 |
| `public/js/main.js` | 2.684 |
...
Total de `public/js/`: **32.226 linhas em 45 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
