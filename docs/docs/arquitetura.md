...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.971 |
| `public/js/main.js` | 2.701 |
| `public/js/characters.js` | 1.229 |
| `public/js/glbchars.js` | 1.033 |
| `public/js/vmattach.js` | 628 |
| `public/js/weapons.js` | 364 |
| `public/js/springs.js` | 260 |

Total de `public/js/`: **40.491 linhas em 55 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
