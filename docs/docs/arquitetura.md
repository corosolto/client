...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.891 |
| `public/js/main.js` | 2.729 |
...
Total de `public/js/`: **40.580 linhas em 59 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
