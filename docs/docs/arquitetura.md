...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 8.099 |
| `public/js/main.js` | 3.661 |
...
Total de `public/js/`: **57.015 linhas em 112 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
