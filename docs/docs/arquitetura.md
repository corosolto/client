...
| `public/js/weapons.js` | 368 |
| `public/js/springs.js` | 259 |

Total de `public/js/`: **43.877 linhas em 66 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
