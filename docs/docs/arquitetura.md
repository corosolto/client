...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.142 |
| `public/js/main.js` | 2.989 |
...
Total de `public/js/`: **33.469 linhas em 50 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
