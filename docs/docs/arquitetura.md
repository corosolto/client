...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.433 |
| `public/js/main.js` | 3.481 |
...
Total de `public/js/`: **46.894 linhas em 93 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
