...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.959 |
| `public/js/main.js` | 3.663 |
...
Total de `public/js/`: **54.638 linhas em 108 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
