...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.437 |
| `public/js/main.js` | 3.485 |
...
Total de `public/js/`: **46.965 linhas em 94 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
