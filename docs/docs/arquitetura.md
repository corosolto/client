...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.083 |
| `public/js/main.js` | 2.707 |
...
Total de `public/js/`: **35.453 linhas em 52 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
