...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.383 |
| `public/js/main.js` | 3.387 |
...
Total de `public/js/`: **41.248 linhas em 73 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
