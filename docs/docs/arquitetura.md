...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.170 |
| `public/js/main.js` | 3.135 |
...
Total de `public/js/`: **36.362 linhas em 56 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
