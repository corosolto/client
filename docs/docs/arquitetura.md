...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 8.055 |
| `public/js/main.js` | 3.657 |
...
Total de `public/js/`: **55.128 linhas em 111 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
