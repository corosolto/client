...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.374 |
| `public/js/main.js` | 3.385 |
...
Total de `public/js/`: **41.134 linhas em 73 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
