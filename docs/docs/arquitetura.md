...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.484 |
| `public/js/main.js` | 3.572 |
...
Total de `public/js/`: **49.992 linhas em 98 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
