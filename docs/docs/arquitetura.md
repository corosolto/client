...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.204 |
| `public/js/main.js` | 3.181 |
...
Total de `public/js/`: **36.714 linhas em 57 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
