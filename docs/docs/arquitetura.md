...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.424 |
| `public/js/main.js` | 3.407 |
| `public/js/characters.js` | 1.073 |
| `public/js/glbchars.js` | 850 |
| `public/js/vmattach.js` | 628 |
| `public/js/weapons.js` | 353 |
| `public/js/springs.js` | 260 |

Total de `public/js/`: **44.573 linhas em 90 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
