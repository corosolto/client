...
| `public/js/glbchars.js` | 878 |
| `public/js/vmattach.js` | 628 |
| `public/js/weapons.js` | 344 |
| `public/js/springs.js` | 260 |

Total de `public/js/`: **29.708 linhas em 39 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
