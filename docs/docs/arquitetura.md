...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 6.988 |
| `public/js/main.js` | 2.990 |
...
Total de `public/js/`: **33.314 linhas em 50 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
