...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.368 |
| `public/js/main.js` | 3.381 |
...
Total de `public/js/`: **39.655 linhas em 68 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
