...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.350 |
| `public/js/main.js` | 3.367 |
...
Total de `public/js/`: **37.852 linhas em 58 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
