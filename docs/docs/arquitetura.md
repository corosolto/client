...
| Arquivo | Linhas |
|---|---:|
| `public/js/game.js` | 7.075 |
| `public/js/main.js` | 2.702 |
...
Total de `public/js/`: **32.858 linhas em 47 arquivos**. O índice símbolo→linha, com a tabela de conflito, é outro bloco gerado: `tools/eval/ARCH.md` (`npm run arch`).
