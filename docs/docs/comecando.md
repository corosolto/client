...
|---|---:|---|
| Código do jogo | 51.457 linhas em 99 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 429 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `atacadao_treta` | Atacadão da Treta | **captura** | `map_atacadao.js` | 260 |
