...
|---|---:|---|
| Código do jogo | 51.969 linhas em 99 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.533** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.601 linhas | `wc -l public/js/main.js` |
...
| Props em GLB | 190 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 431 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
