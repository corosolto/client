...
|---|---:|---|
| Código do jogo | 52.001 linhas em 99 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.555** linhas | `wc -l public/js/game.js` |
...
| Props em GLB | 191 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 433 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 80 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.292` | `public/js/version.js` e `package.json` (batem) |
