...
|---|---:|---|
| Código do jogo | 56.654 linhas em 109 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 569 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
