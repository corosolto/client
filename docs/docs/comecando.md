...
|---|---:|---|
| Código do jogo | 56.643 linhas em 109 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.995** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.659 linhas | `wc -l public/js/main.js` |
...
| Props em GLB | 202 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 568 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 100 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.293` | `public/js/version.js` e `package.json` (batem) |
