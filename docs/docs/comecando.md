...
|---|---:|---|
| Código do jogo | 54.379 linhas em 111 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8.045** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.632 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 553 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` tem **401 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
