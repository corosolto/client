...
|---|---:|---|
| Código do jogo | 44.195 linhas em 86 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 322 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 72 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.232` | `public/js/version.js` e `package.json` (batem) |
