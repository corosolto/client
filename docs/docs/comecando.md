...
|---|---:|---|
| Código do jogo | 49.816 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props em GLB | 180 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 414 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
