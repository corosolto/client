...
|---|---:|---|
| Código do jogo | 36.684 linhas em 57 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.200** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.179 linhas | `wc -l public/js/main.js` |
...
| Versão | `2.0.0-alpha.206` | `public/js/version.js` e `package.json` (batem) |
