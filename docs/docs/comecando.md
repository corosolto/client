...
|---|---:|---|
| Código do jogo | 46.322 linhas em 92 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 344 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `penitenciaria` | Penitenciária da Treta | **captura** | `map_penitenciaria.js` | 731 |
