...
|---|---:|---|
| Código do jogo | 36.366 linhas em 56 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.170** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.135 linhas | `wc -l public/js/main.js` |
