...
|---|---:|---|
| Código do jogo | 46.891 linhas em 93 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props em GLB | 165 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| `escadao` | Escadão (Morro) | **captura** | `map_escadao.js` | 1.462 |
