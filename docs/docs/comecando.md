...
|---|---:|---|
| Código do jogo | 44.893 linhas em 90 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 346 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `piscina_treta` | Piscina da Treta | rodadas | `map_piscina.js` | 928 |
...
`package.json` tem **228 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
