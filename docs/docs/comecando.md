...
|---|---:|---|
| Código do jogo | 36.845 linhas em 57 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.219** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.195 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 219 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 58 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.209` | `public/js/version.js` e `package.json` (batem) |
