...
|---|---:|---|
| Código do jogo | 49.167 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.515** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 408 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
