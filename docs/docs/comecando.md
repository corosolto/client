...
|---|---:|---|
| Código do jogo | 36.714 linhas em 57 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.204** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.181 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 218 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 62 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.207` | `public/js/version.js` e `package.json` (batem) |
...
`package.json` tem **135 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
