...
|---|---:|---|
| Código do jogo | 46.257 linhas em 92 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 343 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `penitenciaria` | Penitenciária da Treta | **captura** | `map_penitenciaria.js` | 668 |
...
`package.json` tem **227 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
