...
|---|---:|---|
| Código do jogo | 42.087 linhas em 62 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 306 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `velho_oeste` | Sertão da Treta | **captura** | `map_velho_oeste.js` | 873 |
...
`package.json` tem **193 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
