...
|---|---:|---|
| Código do jogo | 41.184 linhas em 59 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.279** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 295 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
