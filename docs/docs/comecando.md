...
|---|---:|---|
| Código do jogo | 57.015 linhas em 112 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8.099** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.661 linhas | `wc -l public/js/main.js` |
...
| Props em GLB | 197 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 598 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 100 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.290` | `public/js/version.js` e `package.json` (batem) |
...
| `piscina_treta` | Piscina da Treta | rodadas | `map_piscina.js` | 1.104 |
| `loja_h` | Loja H (Estacionamento) | **captura** | `map_havan.js` | 2.064 |
| `ferro_velho` | Ferro Velho do Zé | **captura** | `map_ferrovelho.js` | 2.025 |
