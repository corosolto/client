...
|---|---:|---|
| Código do jogo | 51.438 linhas em 99 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props em GLB | 183 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 428 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` tem **265 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
