...
| Versão | `2.0.0-alpha.237` | `public/js/version.js` e `package.json` (batem) |
...
| `velho_oeste` | Sertão da Treta | **captura** | `map_velho_oeste.js` | 1.009 |
...
`package.json` tem **220 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
