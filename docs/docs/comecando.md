...
|---|---:|---|
| Código do jogo | 42.946 linhas em 81 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 308 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 69 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.234` | `public/js/version.js` e `package.json` (batem) |
