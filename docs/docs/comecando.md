...
|---|---:|---|
| Código do jogo | 53.872 linhas em 108 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.938** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.598 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 517 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
