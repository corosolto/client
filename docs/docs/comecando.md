...
|---|---:|---|
| Código do jogo | 31.982 linhas em 44 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.920** linhas | `wc -l public/js/game.js` |
...
| Versão | `2.0.0-alpha.172` | `public/js/version.js` — **DIVERGE do `package.json`: `2.0.0-alpha.176`** |
