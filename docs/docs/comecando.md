...
|---|---:|---|
| Código do jogo | 53.088 linhas em 108 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.938** linhas | `wc -l public/js/game.js` |
...
| Props em GLB | 182 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 510 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 96 | `git ls-files 'tools/*.mjs' \| wc -l` |
...
| `posto_treta` | Posto da Treta | **captura** | `map_posto.js` | 507 |
...
| `penitenciaria` | Penitenciária da Treta | **captura** | `map_penitenciaria.js` | 265 |
