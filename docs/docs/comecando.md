...
|---|---:|---|
| Código do jogo | 46.962 linhas em 94 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.435** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.488 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 366 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
