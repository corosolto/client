...
|---|---:|---|
| Código do jogo | 44.530 linhas em 90 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 332 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `escadao` | Escadão (Morro) | **captura** | `map_escadao.js` | 1.371 |
