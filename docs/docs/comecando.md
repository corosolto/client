...
|---|---:|---|
| Código do jogo | 54.044 linhas em 110 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
`package.json` tem **388 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
