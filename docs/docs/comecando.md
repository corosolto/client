...
|---|---:|---|
| Código do jogo | 31.917 linhas em 45 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.531** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.591 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 190 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
