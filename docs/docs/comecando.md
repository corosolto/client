...
|---|---:|---|
| Código do jogo | 39.090 linhas em 59 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props em GLB | 123 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 243 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
|---|---|---|---|---:|
| `escadao` | Escadão (Morro) | **captura** | `map_escadao.js` | 1.235 |
...
`package.json` tem **166 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
