...
|---|---:|---|
| Código do jogo | 56.964 linhas em 109 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8.017** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.688 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 573 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 100 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.300` | `public/js/version.js` e `package.json` (batem) |
