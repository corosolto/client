...
|---|---:|---|
| Código do jogo | 45.882 linhas em 64 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.401** linhas | `wc -l public/js/game.js` |
...
|---|---|---|---|---:|
| `praca_poderes` | Praça dos Três Poderes | rodadas | `map_brasilia.js` | 2.230 |
...
| `quebrada` | Quebrada (Rua do Baile) | **captura** | `map_quebrada.js` | 1.660 |
| `fy_escadao` | Escadão (Morro) | **captura** | `map_escadao.js` | 817 |
| `fy_campomorro` | Campo do Morro | **captura** | `map_campomorro.js` | 917 |
| `fy_lajes` | Lajes (Comunidade) | **captura** | `map_lajes_authored.js` | 1.396 |
| `fy_corrego` | Córrego (Favela de SP) | **captura** | `map_corrego.js` | 1.381 |
| `fy_mansao` | Mansão do Joá | **captura** | `map_mansao.js` | 1.209 |
| `posto_treta` | Posto da Treta | **captura** | `map_posto.js` | 654 |
| `upa_24h` | UPA 24h da Treta | **captura** | `map_upa.js` | 534 |
| `obras_prefeitura` | Obras da Prefeitura | **captura** | `map_obras.js` | 587 |
| `atacadao_treta` | Atacadão da Treta | **captura** | `map_atacadao.js` | 591 |
| `parque_treta` | Parque da Treta | **captura** | `map_parque.js` | 628 |
| `velho_oeste` | Velho Oeste da Treta | **captura** | `map_velho_oeste.js` | 560 |
| `penitenciaria` | Penitenciária da Treta | **captura** | `map_penitenciaria.js` | 541 |
