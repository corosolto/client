...
|---|---:|---|
| Código do jogo | 56.458 linhas em 112 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8.094** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 594 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 100 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.287` | `public/js/version.js` e `package.json` (batem) |
...
| `piscina_treta` | Piscina da Treta | rodadas | `map_piscina.js` | 1.100 |
