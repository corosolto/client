...
|---|---:|---|
| Código do jogo | 51.111 linhas em 97 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.554** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 426 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` tem **262 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
