...
|---|---:|---|
| Código do jogo | 50.580 linhas em 97 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 423 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
