...
|---|---:|---|
| Código do jogo | 32.226 linhas em 45 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.901** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.684 linhas | `wc -l public/js/main.js` |
