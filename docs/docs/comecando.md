...
|---|---:|---|
| Código do jogo | 54.667 linhas em 111 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8.045** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.624 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 560 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
