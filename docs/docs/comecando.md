...
|---|---:|---|
| Código do jogo | 37.545 linhas em 57 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.305** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 228 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
