...
|---|---:|---|
| Código do jogo | 53.992 linhas em 109 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8.044** linhas | `wc -l public/js/game.js` |
...
`package.json` tem **387 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
