...
|---|---:|---|
| Código do jogo | 44.713 linhas em 90 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 342 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 72 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.241` | `public/js/version.js` e `package.json` (batem) |
...
| `velho_oeste` | Sertão da Treta | **captura** | `map_velho_oeste.js` | 1.047 |
