...
|---|---:|---|
| Código do jogo | 54.673 linhas em 111 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
`package.json` tem **406 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
