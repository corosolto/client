...
|---|---:|---|
| Código do jogo | 56.501 linhas em 109 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.994** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 562 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| `atacadao_treta` | Atacadão da Treta | **captura** | `map_atacadao.js` | 786 |
