...
|---|---:|---|
| Código do jogo | 41.603 linhas em 59 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `mansao` | Mansão do Joá | **captura** | `map_mansao.js` | 1.201 |
