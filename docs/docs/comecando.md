...
|---|---:|---|
| Código do jogo | 53.997 linhas em 109 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **8.047** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 540 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
