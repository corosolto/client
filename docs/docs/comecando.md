...
|---|---:|---|
| Código do jogo | 36.095 linhas em 56 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.152** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.995 linhas | `wc -l public/js/main.js` |
