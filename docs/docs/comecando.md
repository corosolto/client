...
|---|---:|---|
| Código do jogo | 46.729 linhas em 93 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 357 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 73 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.242` | `public/js/version.js` e `package.json` (batem) |
...
|---|---|---|---|---:|
| `mansao` | Mansão do Joá | **captura** | `map_mansao.js` | 1.391 |
