...
|---|---:|---|
| Código do jogo | 46.608 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.621** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 354 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
