...
|---|---:|---|
| Código do jogo | 44.868 linhas em 90 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.446** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 351 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
