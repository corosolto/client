...
|---|---:|---|
| Código do jogo | 47.751 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `obras_prefeitura` | Obras da Prefeitura | **captura** | `map_obras.js` | 438 |
