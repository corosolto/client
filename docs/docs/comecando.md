...
|---|---:|---|
| Código do jogo | 35.736 linhas em 52 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.076** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.707 linhas | `wc -l public/js/main.js` |
...
| Mapas no menu | 14 — 3 abrem em rodadas, **11 em captura** | `MAPS` / `ctfMode` |
...
**14 mapas registrados** — 3 abrem em rodadas e 11 em captura. `ctfMode` **abre** o mapa em captura, não prende: o jogador troca no menu (é a `MOD1`). Há 16 arquivos `map_*.js` em `public/js/` — arquivo no disco **não** implica mapa jogável.
