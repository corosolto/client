...
|---|---:|---|
| Código do jogo | 54.277 linhas em 111 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Scripts do arnês | 545 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
`package.json` tem **391 scripts**; o motivo de cada um mora em `SCRIPTS.md` (migrado das chaves `//nome` em 18/08/2026) — é onde está o porquê.
