...
|---|---:|---|
| Código do jogo | 49.148 linhas em 96 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.505** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 406 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
