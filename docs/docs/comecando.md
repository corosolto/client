...
|---|---:|---|
| Código do jogo | 50.796 linhas em 97 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Props em GLB | 181 | `git ls-files 'public/models/props/*.glb' \| wc -l` |
...
| Scripts do arnês | 424 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
