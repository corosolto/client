...
|---|---:|---|
| Código do jogo | 47.050 linhas em 94 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.469** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.485 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 368 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
| Scripts de pipeline | 75 | `git ls-files 'tools/*.mjs' \| wc -l` |
| Tarefas de entrada escritas | 26 | `git ls-files 'docs/issues/[0-9]*.md' \| wc -l` |
| Versão | `2.0.0-alpha.248` | `public/js/version.js` e `package.json` (batem) |
