# Handoff da continuação de viewmodel

Duas lanes escreveram este relatório em paralelo e nenhuma viu a outra. Os dois
ficam: são registro do que cada uma mediu, e apagar um perde a memória da lane.

---

## Lane `glm/vm-controles-final` (auditoria dos controles, veredito do dono)
...
## Lane `feat/fps-paid-viewmodels-aaa` (arsenal, BUG-76/77/78)
