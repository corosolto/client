...
| revolver38 | Pose de duas mãos com o cano a ~55° e frame da família herdado do olho antigo; no ADS as luvas cobriam a arma; pontas do polegar e do indicador a 6,2–6,7 cm com o cartucho no meio. | Frame próprio (fov da pistola, 1,00×/0,95× da escala da AK), ADS com alça a 0,35 m e arma 0,8 cm mais alta no punho; CCD de polegar e indicador fecha a pinça nas janelas em que o cartucho está na mão. |
