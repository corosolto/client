...
| Prepare a frente Rifles do CSBrasil. Leia integralmente: /V… | 01a073e3-1632-73d3-9683-e1394339fa8e | PRIORIDADE hoje: M4 tactical offline aguarda checkpoint Astra e uma única intervenção de menor risco; nenhum runtime/material compartilhado |
| Elevar visual do Escadão | 01a073e5-b003-7993-afd6-41d31e25d98d | RETOMADA no checkpoint limpo ada21d8d: duas divergências do grafo e horizonte pendentes; preservar passagens e entregar candidato para crítica antes de publicação |
...
| Elevar visualmente o mapa Sertão | 01a073c0-b824-7503-b28a-f7522cececcc | PRIORIDADE produção hoje: atualizar PR516 contra alpha.233 c7302096, corrigir falhas remotas do head d8b7584d, validar/publicar head limpo; merge só após CI verde |
| Revisar e shipar PR Miticos | 01a07485-2ddf-7052-b858-f814cabc30f7 | PRIORIDADE hoje: implementar experimento privado Cuca `cuca-left-grip.glb`, clip aditivo de LeftHand/Curl_L/Curl_L_Tip e crítica Astra; inventário mantém Zumbi/demais para PR substituto de #481 |
