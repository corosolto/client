...
|---|---:|---|
| Código do jogo | 41.182 linhas em 59 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.291** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.813 linhas | `wc -l public/js/main.js` |
