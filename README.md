...
|---|---:|---|
| Código do jogo | 46.438 linhas em 93 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
Three.js sai de `public/vendor/three.module.js` (**sem CDN, sem npm no runtime**). Astro e Vercel de `package.json` + `astro.config.mjs` + `vercel.json`. Dos scripts de `tools/`, **140** importam Playwright, **54** importam gltf-transform e **10** importam meshoptimizer.
...
|---|---|---|---|---:|
| `mansao` | Mansão do Joá | **captura** | `map_mansao.js` | 1.383 |
