...
|---|---:|---|
| Código do jogo | 33.469 linhas em 50 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.142** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.989 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 207 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
