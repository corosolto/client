...
|---|---:|---|
| Código do jogo | 34.958 linhas em 51 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.918** linhas | `wc -l public/js/game.js` |
...
| `corrego` | Córrego (Favela de SP) | **captura** | `map_corrego.js` | 1.284 |
