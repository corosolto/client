...
|---|---:|---|
| Código do jogo | 46.321 linhas em 92 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| Jogo | ES modules vanilla, **zero build** | 92 arquivos |
...
| `penitenciaria` | Penitenciária da Treta | **captura** | `map_penitenciaria.js` | 728 |
