...
|---|---:|---|
| Código do jogo | 43.789 linhas em 65 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.558** linhas | `wc -l public/js/game.js` |
...
Three.js sai de `public/vendor/three.module.js` (**sem CDN, sem npm no runtime**). Astro e Vercel de `package.json` + `astro.config.mjs` + `vercel.json`. Dos scripts de `tools/`, **157** importam Playwright, **68** importam gltf-transform e **5** importam meshoptimizer.
