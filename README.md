...
|---|---:|---|
| Código do jogo | 47.348 linhas em 95 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.472** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.521 linhas | `wc -l public/js/main.js` |
