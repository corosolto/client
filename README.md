...
|---|---:|---|
| Código do jogo | 33.234 linhas em 49 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **6.980** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.944 linhas | `wc -l public/js/main.js` |
...
| Scripts do arnês | 206 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
