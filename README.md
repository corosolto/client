...
|---|---:|---|
| Código do jogo | 40.683 linhas em 57 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
...
| `fy_campomorro` | Campo do Morro | **captura** | `map_campomorro.js` | 670 |
