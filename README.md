...
|---|---:|---|
| Código do jogo | 50.224 linhas em 99 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.484** linhas | `wc -l public/js/game.js` |
| `main.js` | 3.572 linhas | `wc -l public/js/main.js` |
...
Three.js sai de `public/vendor/three.module.js` (**sem CDN, sem npm no runtime**). Astro e Vercel de `package.json` + `astro.config.mjs` + `vercel.json`. Dos scripts de `tools/`, **153** importam Playwright, **59** importam gltf-transform e **10** importam meshoptimizer.
...
| `parque_treta` | Parque da Treta | **captura** | `map_parque.js` | 925 |
| `velho_oeste` | Sertão da Treta | **captura** | `map_velho_oeste.js` | 1.061 |
| `penitenciaria` | Carandiru | **captura** | `map_penitenciaria.js` | 1.008 |
