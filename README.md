...
|---|---:|---|
| Código do jogo | 32.646 linhas em 46 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.122** linhas | `wc -l public/js/game.js` |
...
| Scripts do arnês | 204 | `git ls-files 'tools/eval/*.mjs' 'tools/eval/*.py' \| wc -l` |
...
| Jogo | ES modules vanilla, **zero build** | 46 arquivos |
