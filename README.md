...
|---|---:|---|
| Código do jogo | 41.103 linhas em 59 arquivos | `git ls-files public/js/*.js \| xargs wc -l` |
| `game.js` | **7.244** linhas | `wc -l public/js/game.js` |
| `main.js` | 2.794 linhas | `wc -l public/js/main.js` |
