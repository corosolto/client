...
- **Versão:** `2.0.0-alpha.288`
- **Conteúdo jogável:** 6 facções, 53 personagens, 18 mapas e 26 armas com GLB
- **Código do jogo:** 51.457 linhas em 99 módulos JavaScript
- **Automação:** 266 comandos npm, 429 scripts de avaliação e 80 scripts de pipeline
