...
- **Versão:** `2.0.0-alpha.233`
- **Conteúdo jogável:** 5 facções, 44 personagens, 16 mapas e 26 armas com GLB
- **Código do jogo:** 42.802 linhas em 79 módulos JavaScript
- **Automação:** 203 comandos npm, 303 scripts de avaliação e 73 scripts de pipeline
