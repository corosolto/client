...
- **Versão:** `2.0.0-alpha.189`
- **Conteúdo jogável:** 5 facções, 44 personagens, 12 mapas e 26 armas com GLB
- **Código do jogo:** 33.237 linhas em 49 módulos JavaScript
- **Automação:** 124 comandos npm, 206 scripts de avaliação e 55 scripts de pipeline
