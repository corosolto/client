...
- **Versão:** `2.0.0-alpha.225`
- **Conteúdo jogável:** 5 facções, 44 personagens, 14 mapas e 26 armas com GLB
- **Código do jogo:** 39.570 linhas em 64 módulos JavaScript
- **Automação:** 178 comandos npm, 249 scripts de avaliação e 61 scripts de pipeline
