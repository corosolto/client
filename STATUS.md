...
- **Conteúdo jogável:** 10 facções, 62 personagens, 18 mapas e 27 armas com GLB
- **Código do jogo:** 42.209 linhas em 60 módulos JavaScript
- **Automação:** 187 comandos npm, 301 scripts de avaliação e 77 scripts de pipeline
