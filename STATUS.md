...
- **Versão:** `2.0.0-alpha.242`
- **Conteúdo jogável:** 5 facções, 44 personagens, 17 mapas e 26 armas com GLB
- **Código do jogo:** 46.729 linhas em 93 módulos JavaScript
- **Automação:** 229 comandos npm, 358 scripts de avaliação e 73 scripts de pipeline
