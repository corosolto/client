...
- **Versão:** `2.0.0-alpha.191`
- **Conteúdo jogável:** 5 facções, 44 personagens, 14 mapas e 26 armas com GLB
- **Código do jogo:** 35.736 linhas em 52 módulos JavaScript
- **Automação:** 129 comandos npm, 213 scripts de avaliação e 57 scripts de pipeline
