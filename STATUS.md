...
- **Conteúdo jogável:** 10 facções, 62 personagens, 10 mapas e 27 armas com GLB
- **Código do jogo:** 36.159 linhas em 45 módulos JavaScript
- **Automação:** 133 comandos npm, 227 scripts de avaliação e 63 scripts de pipeline
