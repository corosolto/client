...
const extra=['public/js/map_preview.js','public/js/map_preview_media.js','public/map-preview.css','public/img/map-previews/amazonia.mp4','public/js/skylife.js','public/models/ambient/arara_voo.glb',
...
for(const file of Object.keys(manifest.mainMenuUnchanged)) {
 ...
 const patched=patchMapPreviewMenu(file,base.toString()), patchedHash=createHash('sha256').update(patched).digest('hex');
