...
const extra=['public/models/props/galinha_mint_amazonia.glb','public/models/props/pintinho_mint_amazonia.glb','public/js/map_preview.js','public/js/map_preview_media.js','public/map-preview.css','public/img/map-previews/amazonia.mp4','public/js/skylife.js','public/models/ambient/arara_voo.glb',
