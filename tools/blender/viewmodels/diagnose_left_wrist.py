"""Render the support-hand orientation grid at the measured AK foregrip."""
...
OUT = ROOT / "artifacts" / "viewmodels" / "ak-pilot" / "renders" / "left_orientation_grid"
...
for x_degrees in (0, 90, 180, 270):
    for y_degrees in (0, 90, 180, 270):
        ...
        path = OUT / f"left_x{x_degrees:03d}_y{y_degrees:03d}.png"
        bpy.context.scene.render.filepath = str(path)
        bpy.ops.render.render(write_still=True)

print(f"LEFT_WRIST_GRID {OUT}")
