...
export const CHASSIS_PACK = Object.freeze({
  ...
  Kolibri: { armaFbx: 'Weapon/Kolibri.FBX', poseFbx: 'Character/A_FP_Kolibri_Pose.FBX', prefab: 'Kolibri', settings: 'Kolibri', tipo: 'pistola',
    nota: 'a Kolibri é a micropistola de 2,7 mm (8 cm de comprimento medido), não uma submetralhadora' },
