...
try {
  ...
  const views=[
    ...
    {id:'casa-central-janela-oposta',pos:[-1.4,2.75,15.7],look:[0,3.8,24]},
    {id:'casa-central-janela-rua',pos:[0,0,24],look:[-1.4,4.2,16.8]},
    {id:'mirante-casa-oeste-entrada',pos:[-15,7.56,-26],look:[-12,8.8,-26]},
    {id:'mirante-casa-oeste-interior',pos:[-12,7.56,-26],look:[-5,9.0,-27]},
    {id:'mirante-casa-leste-entrada',pos:[15,7.56,-27],look:[12,8.8,-27]},
    {id:'mirante-casa-leste-interior',pos:[12,7.56,-27],look:[5,9.0,-27]},
