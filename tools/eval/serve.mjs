...
http.createServer(async (req, res) => {
  try {
    ...
    /* Casca de eval de personagem (deste PR): HTML mínimo com o importmap, para a régua
       montar um personagem sem subir o jogo inteiro. */
    if (p === '/eval-character.html') { res.writeHead(200, { 'content-type': 'text/html' }); return res.end(CHARACTER_EVAL_SHELL); }
