...
let saida = 0;
try {
  await page.goto(`${BASE}/?debug=1&vmauthored=1&auto=E&map=piscina_treta&armaslazy=0&vmready=ar,ak,lmg,sniper,shotgun,revolver,mp5,pistol`, { waitUntil: 'load', timeout: 180000 });
