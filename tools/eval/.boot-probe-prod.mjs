...
await pag.goto('https://www.csbrasil.online/?debug=1', { waitUntil: 'commit', timeout: 300000 });
const t0=Date.now(); await pag.waitForSelector('#splash-enter:not(.hidden)', { timeout: 300000 });
console.log('splash_ms_apos_commit', Date.now()-t0);
