// Captura WebGL real do Córrego em 3:2/5x5 ou 16:9/8x8, com câmeras fixas.
...
const cameras = [
  ...
  { name: 'quarta-rampa', pos: [-0.5, 0.9, 35], target: [4.5, -0.7, 29] },
  { name: 'travessia-alta', pos: [12.8, 6.9, -16.5], target: [0, 5.4, -11] },
  { name: 'sobrados-janelas', pos: [2.0, 3.2, -11], target: [10.15, 3.8, -15.1] },
  { name: 'overview', pos: [40, 29, 46], target: [0, 1.0, 0] },
];

mkdirSync(out, { recursive: true });
const sourceSHA256 = createHash('sha256').update(readFileSync('public/js/map_corrego.js')).digest('hex');
...
try {
  ...
  /* 5x5 preserva orçamento de 50 fps no p95. Em 8x8 o mapa aceita o patamar de
     30 fps, ainda com teto de 50 ms para impedir travadas longas. Os dois números
