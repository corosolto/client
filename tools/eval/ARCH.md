...
|---|---:|---:|
| `public/js/game.js` | 7352 | 273 |
| `public/js/main.js` | 3388 | 274 |
...
Os 15 maiores somam **3109 linhas (42% do arquivo)**. Método grande = PR irrevisável e merge conflitante.

| Linhas | Início | Método | |
|---:|---:|---|---|
| 809 | 5985 | `_updateBot()` | ⚠️ candidato a extração |
| 579 | 591 | `constructor()` | 🔴 append-only |
| 249 | 5195 | `_updatePlayer()` |  |
| 248 | 2239 | `_resetPositions()` |  |
| 241 | 1268 | `_buildViewModels()` |  |
| 148 | 5455 | `_updatePickups()` |  |
| 133 | 4568 | `_botCtf()` |  |
| 115 | 1964 | `_touchControls()` |  |
| 92 | 5103 | `_moveEntity()` |  |
| 89 | 7219 | `update()` | 🔴 append-only |
| 84 | 3044 | `_tryShoot()` |  |
| 84 | 4301 | `_initCTF()` |  |
| 80 | 7139 | `_updateHud()` |  |
| 79 | 3357 | `_kill()` |  |
...
| **BOTS / JOGABILIDADE** | `160–163` `214–214` `240–251` `521–532` `3310–3435` `4245–4300` `4464–4700` `4783–4805` `5195–5443` `5806–5823` `5933–5963` `5985–6793` | — |
| **MAPAS / MUNDO** | `1214–1267` `2239–2486` `4301–4440` `5455–5602` | `public/js/maps.js` `public/js/mapprops.js` `public/js/map_brasilia.js` `public/js/map_havan.js` `public/js/map_piscina.js` `public/js/map_piscinao_ramos.js` `public/js/map_ferrovelho.js` |
...
| **UI / HUD / MENU** | `1170–1213` `2691–2713` `2729–2734` `2748–2754` `3436–3514` `3531–3584` `3600–3663` `6962–7025` `7056–7103` `7139–7218` | `public/js/main.js` `public/style.css` `src/pages/index.astro` |
| **ÁUDIO** | — | `public/js/audio.js` |
| **PERSONAGENS** | — | `public/js/characters.js` `public/js/glbchars.js` |
| **SITE / BACKEND** | — | `src/` `supabase/` |

**🔴 Zonas vermelhas (append-only, qualquer frente pode precisar):** `update()` 7219–7307 · `_dom()` 1170–1213 · `constructor()` 591–1169

Nenhuma sobreposição entre frentes — todas as faixas são disjuntas. ✓

Cobertura: **3694 de 7352 linhas (50%)** do `game.js` têm dono declarado. O resto é território neutro — declare a frente mesmo assim.
...
| 4512 | `_walkReach()` | 18 |
| 4530 | `_wpComp()` | 16 |
| 4546 | `_findPathLocal()` | 22 |
| 4568 | `_botCtf()` | 133 |
| 4701 | `_hideCtfHud()` | 6 |
| 4707 | `_updateCtfHud()` | 76 |
| 4783 | `_collide()` | 23 |
| 4806 | `_collideRot()` | 26 |
| 4832 | `_freeSpot()` | 30 |
| 4862 | `_retaAndavel()` | 20 |
| 4882 | `_walkDepth()` | 16 |
| 4898 | `_noteHit()` | 17 |
| 4915 | `_deathFeedback()` | 43 |
| 4958 | `_updateReplayCam()` | 35 |
| 4993 | `_toggleCamView()` | 11 |
| 5004 | `_syncCamViewVis()` | 8 |
| 5012 | `_ensurePlayerTP()` | 25 |
| 5037 | `_updatePlayerTP()` | 35 |
| 5072 | `_tpDeath()` | 18 |
| 5090 | `_tpRevive()` | 13 |
| 5103 | `_moveEntity()` | 92 |
| 5195 | `_updatePlayer()` | 249 |
| 5444 | `_footstepSurface()` | 11 |
| 5455 | `_updatePickups()` | 148 |
| 5603 | `_wpnMode()` | 5 |
| 5608 | `_botWeapon()` | 10 |
| 5618 | `_municaoInfinita()` | 1 |
| 5619 | `_pickupAllowed()` | 7 |
| 5626 | `_grabPickup()` | 35 |
| 5661 | `_assentarNoChao()` | 10 |
| 5671 | `refreshPickupModels()` | 24 |
| 5695 | `_dropWeapon()` | 20 |
| 5715 | `_sumirDrop()` | 36 |
| 5751 | `_spawnY()` | 3 |
| 5754 | `_pickSpawn()` | 23 |
| 5777 | `_respawnPlayer()` | 29 |
| 5806 | `_losClear()` | 18 |
| 5824 | `_botCall()` | 41 |
| 5865 | `_teamMarkTex()` | 23 |
| 5888 | `_makeTeamMark()` | 16 |
| 5904 | `_syncRemoteWeapon()` | 22 |
| 5926 | `_updateTeamMark()` | 7 |
| 5933 | `_botEye()` | 1 |
| 5934 | `_enemyOf()` | 8 |
| 5942 | `_duelToken()` | 22 |
| 5964 | `_respawnEntity()` | 21 |
| 5985 | `_updateBot()` | 809 |
| 6794 | `_flushTraining()` | 13 |
| 6807 | `_updateBotNN()` | 71 |
| 6878 | `_botShootNN()` | 46 |
| 6924 | `_radarFoot()` | 38 |
| 6962 | `_updateRadar()` | 64 |
| 7026 | `_banner()` | 26 |
| 7052 | `_resultadoDaRodada()` | 4 |
| 7056 | `_showScoreboard()` | 48 |
| 7104 | `_updateWeaponHud()` | 35 |
| 7139 | `_updateHud()` | 80 |
| 7219 | `update()` | 89 |
| 7308 | `dispose()` | 44 |
