...
console.log('TESTE http://127.0.0.1:4401/?debug=1&auto=P,mst&map=piscina_treta&vmauthored=1&vmready=ak&vmweapon=m4,md97,scar,famas,m92,akm,g3,carbine,tavor,mosin,svd,sks,rem700,g3sg1&vmqa=precision');
