...
const mag = scene.getObjectByName('Magazine');
const bolt = scene.getObjectByName('Charger');
...
check(trackMotion(gltf, 'shoot', 'Charger.position') >= 4, 'shoot não cicla a alavanca própria');
check(trackMotion(gltf, 'shoot', 'Mechanism.position') >= 4, 'shoot não cicla o mecanismo próprio');
check(trackMotion(gltf, 'shoot', 'Trigger.quaternion') >= 0.08, 'shoot não aciona o gatilho próprio');
...
check(trackMotion(gltf, 'reload_empty', 'Charger.position') >= 4, 'reload_empty não aciona a alavanca');
check(trackMotion(gltf, 'reload_empty', 'Mechanism.position') >= 4, 'reload_empty não aciona o mecanismo');
...
await mutant('sem-pente', (copy) => copy.scene.getObjectByName('Magazine')?.removeFromParent(), (copy) => !copy.scene.getObjectByName('Magazine'));
...
await mutant('ferrolho-congelado', (copy) => freezeTracks(copy, /^shoot$/, /^Charger\./), (copy) => trackMotion(copy, 'shoot', 'Charger.position') < 4);
await mutant('gatilho-congelado', (copy) => freezeTracks(copy, /^shoot$/, /^Trigger\./), (copy) => trackMotion(copy, 'shoot', 'Trigger.quaternion') < 0.08);
await mutant('alavanca-congelada', (copy) => freezeTracks(copy, /^reload_empty$/, /^Charger\./), (copy) => trackMotion(copy, 'reload_empty', 'Charger.position') < 4);
