...
(1440 px de largura), produtos do catálogo privado servidos pelo `vmbytes.js` deste branch. Entradas: `903365fdc7c6ca3e`.
...
| ak | **VERMELHO** 92 px | verde 0.99× AK | n/a | **VERMELHO** 0.61 | verde ok |
...
| deagle | verde 30 px | n/a | **VERMELHO** 0.63× pistola aprovada | n/a | **VERMELHO** 2 falha(s) |
...
- **ak** VERDE — tamanho 0.99× AK, rolagem +13° da AK (informativa), eixo -1° da AK, braço 0.70×, cruz 0 px, olho 2.99 palma, ADS cobre 11.2% (teto 18.5%)
...
- **deagle** VERMELHO — recarrega com objeto no meio do ar: vazia 15% — 2.30 palma da mão, deslocado 3.04 do encaixe, na tela; recarrega com objeto no meio do ar: tatica 29% — 1.95 palma da mão, deslocado 2.63 do encaixe, na tela. Conserto: prender a peça ao osso da mão no clipe reload_* (vm-fix-mags); não é config.
