...
export const CHAR_FX = {
  ...
  // 0.82: no pior corredor quente do Sertão, 0.70 deixava o ganho p95 do
  // contorno oscilar abaixo de 3 L* a 40 m; 0.82 preserva a banda explícita
  // com margem sem tocar no valor de perto (0.18).
