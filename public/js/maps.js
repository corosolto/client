...
import { buildPoolDay, PISCINA_AMBIENCE, PISCINA_PROPS } from './map_piscina.js';
...
export const MAPS = {
  ...
  piscina_treta: { name: 'Piscina da Treta',        build: buildPoolDay, ambience: PISCINA_AMBIENCE, props: PISCINA_PROPS },   // salão fechado do CS 1.6 + anel de vestiário/banheiro/pergolado (kit Mint r2)
