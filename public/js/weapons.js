...
/* A partida carrega só as armas sorteadas; os modelos de exibição são sempre necessários
   para personagem/seleção. Sem lista, o arnês carrega o elenco inteiro. */
export async function preloadWeapons(ids) {
  const wanted = ids && ids.length ? [...ids, ...DISPLAY_MODEL_IDS] : [...WEAPON_IDS, ...DISPLAY_MODEL_IDS];
