...
export function buildFerroVelho(scene, T) {
     ...
     leitura e ficam fora da linha de tiro pra não virar ruído (BAR §2.3). */
  {
    ...
    /* CADEIRA MONOBLOCO branca encardida na porta do escritório (BAR §4.4) */
    {
      ...
      // assento/encosto são occluders: sem malha visível registrada a bala atravessava
      // a cadeira, que o colisor abaixo só declara como corpo (BUG-54).
      occluders.push(mesh(new THREE.BoxGeometry(0.42, 0.05, 0.42), pl, 6.0, 0.44, -29.6, 0.5));
      occluders.push(mesh(new THREE.BoxGeometry(0.42, 0.5, 0.05), pl, 6.0 + Math.sin(0.5) * 0.19, 0.7, -29.6 - Math.cos(0.5) * 0.19, 0.5));
