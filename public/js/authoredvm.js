...
export const AUTHORED_VM_ENABLED = _QS?.get('vmauthored') === '1';
...
// Rollout global fail-closed: sem ?vmauthored=1 tudo permanece no legado alpha.246.
// `vmready` só abre famílias numa sessão de QA explicitamente opt-in.
