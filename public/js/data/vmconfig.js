...
export const VM_FABRICA = Object.freeze({
  ...
  revolver38: F('revolver', 'Viper-357', { frame: { ...CURTA, y: -0.07, rotDeg: [-10, 15, -5] }, ads: A(0.38) }),
  ...
  scar: F('marksman', 'Mk14EBR', { variante: true, recoilScale: 3, frame: { x: 0.2, y: -0.06, z: -0.3, rotDeg: [-2.5, 7.69, 6.19] }, ads: A(0.1) }),
