...
|---|---|---|---|
| `public/` | o **jogo** | 35 arquivos `.js`, 27.938 linhas · Three.js `r160` vendorizado | ES modules servidos crus, **zero build**, sem dependência de runtime |
